...
var _danabrams$elm_media$Media_State$timeGroup = function () {
	var toTimeGroup = F3(
		function (bufferedValue, seekableValue, playedValue) {
			return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
				{
					buffered: _danabrams$elm_media$Media_State$timeRanges(bufferedValue),
					seekable: _danabrams$elm_media$Media_State$timeRanges(seekableValue),
					played: _danabrams$elm_media$Media_State$timeRanges(playedValue)
				});
		});
	...
	function (id, tagger) {
		return _elm_lang$core$Native_Utils.crash(
			'Media.State',
			{
				...
				end: {line: 222, column: 16}
			})('Not Implemented Yet');
	});
var _danabrams$elm_media$Media_State$nowRaw = _danabrams$elm_media$Native_Media.getMediaById;
var _danabrams$elm_media$Media_State$State = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
					return function (f) {
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return {id: a, mediaType: b, playback: c, source: d, currentTime: e, duration: f, ready: g, network: h, timeRanges: i, videoSize: j};
									};
								};
							};
						};
...
var _danabrams$elm_media$Media_State$DataGroup = F2(
	function (a, b) {
		return {ready: a, network: b};
	});
var _danabrams$elm_media$Media_State$TimeGroup = F3(
	function (a, b, c) {
		return {buffered: a, seekable: b, played: c};
	});
...
var _danabrams$elm_media$Media_State$videoSize = A4(
...
var _danabrams$elm_media$Media_State$mediaType = function () {
...
var _danabrams$elm_media$Media_State$networkState = function () {
...
var _danabrams$elm_media$Media_State$readyState = function () {
...
var _danabrams$elm_media$Media_State$mediaError = function () {
	var toMediaError = F2(
...
var _danabrams$elm_media$Media_State$Problem = function (a) {
...
var _danabrams$elm_media$Media_State$default = function (options) {
	return {
		id: options.id,
		mediaType: options.mediaType,
		playback: _danabrams$elm_media$Media_State$Paused,
		source: A2(_elm_lang$core$Maybe$withDefault, '', options.source),
		currentTime: 0.0,
		duration: 0.0,
		ready: _danabrams$elm_media$Media_State$HaveNothing,
		network: _danabrams$elm_media$Media_State$Idle,
		timeRanges: {
			seekable: {ctor: '[]'},
			buffered: {ctor: '[]'},
			played: {ctor: '[]'}
...
var _danabrams$elm_media$Media_State$defaultAudio = function (id) {
	return _danabrams$elm_media$Media_State$default(
		{id: id, mediaType: _danabrams$elm_media$Media_State$Audio, source: _elm_lang$core$Maybe$Nothing});
};
var _danabrams$elm_media$Media_State$defaultVideo = function (id) {
	return _danabrams$elm_media$Media_State$default(
		{id: id, mediaType: _danabrams$elm_media$Media_State$Video, source: _elm_lang$core$Maybe$Nothing});
};
var _danabrams$elm_media$Media_State$playback = function () {
	var toPlayback = F4(
		function (error, ready, ended, paused) {
			var _p4 = error;
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Json_Decode$succeed(
					_danabrams$elm_media$Media_State$Problem(_p4._0));
			} else {
				var _p5 = ready;
				switch (_p5.ctor) {
					case 'HaveNothing':
	...
	return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$resolve(
		A3(
			...
			A3(
				...
				A2(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
					_danabrams$elm_media$Media_State$readyState,
					A2(
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
						_danabrams$elm_media$Media_State$mediaError,
						_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(toPlayback))))));
}();
var _danabrams$elm_media$Media_State$state = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	_danabrams$elm_media$Media_State$videoSize,
	A2(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
		_danabrams$elm_media$Media_State$timeGroup,
		A2(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
			_danabrams$elm_media$Media_State$networkState,
			A2(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
				_danabrams$elm_media$Media_State$readyState,
				A3(
					...
					A3(
						...
						A3(
							...
							A2(
								_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
								_danabrams$elm_media$Media_State$playback,
								A2(
									_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
									_danabrams$elm_media$Media_State$mediaType,
									A3(
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
										'id',
										_elm_lang$core$Json_Decode$string,
										_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_danabrams$elm_media$Media_State$State)))))))))));
var _danabrams$elm_media$Media_State$DecodeError = function (a) {
...
var _danabrams$elm_media$Media_State$now = function (id) {
	return A2(
		_elm_lang$core$Task$andThen,
		function (value) {
			var _p8 = A2(_elm_lang$core$Json_Decode$decodeValue, _danabrams$elm_media$Media_State$state, value);
			if (_p8.ctor === 'Ok') {
				return _elm_lang$core$Task$succeed(_p8._0);
			} else {
				return _elm_lang$core$Task$fail(
					_danabrams$elm_media$Media_State$NotFound(_p8._0));
			}
		},
